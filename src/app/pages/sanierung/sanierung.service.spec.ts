...
describe('SanierungService', () => {
  ...
  it('should update Bank-Kredit pro m² = 100 € when Bank-Kredit is 100000 and wohnflaeche is 1000 m²', () => {
  ...
  it('should update Bank-Kredit pro bau = 50000 € when Bank-Kredit is 100000 and anzahlWohnungen is 2', () => {
    const bankKredit = 100000;
  ...
  it('should update KfW-Zuschuss pro m² = 300 € when KfW-Zuschuss is 30000 and Wohnflaeche is 100', () => {
  ...
  it('should update KfW-Zuschuss pro bau = 10000 € when KfW-Zuschuss is 30000 and Anzahl Wohnungen is 3', () => {
    const kfwZuschuss = 30000;
  ...
  it('should update KfW-Kredit pro m² = 300 € when KfW-Kredit is 30000 and Wohnflaeche is 100', () => {
  ...
  it('should update KfW-Kredit pro bau = 10000 € when KfW-Kredit is 30000 and Anzahl Wohnungen is 3', () => {
    const kfwKredit = 30000;
    const anzahlWohnungen = 3;
  ...
  it('should update Finanzierungskosten-KfW pro m² = 300 € when Finanzierungskosten KfW is 30000 and Wohnflaeche is 100', () => {
  ...
  it('should update GB Annuität approx. 245250 € when foerdersumme is 480000, bankKredit is 40000, afBank is 0.07358175, kreditlaufzeit is 20', () => {
    const foerdersumme = 480000;
    const bankKredit = 40000;
    const afBank = 0.07358175;
    ...
    expect(result).toBeCloseTo(245250.203);
  });

  it('should update GB Annuität approx. 245250 € when foerdersumme is 520000, bankKredit is 0, afBank is 0.07358175, kreditlaufzeit is 20', () => {
    const foerdersumme = 760000;
    const bankKredit = 0;
    const afBank = 0.1344929927;
  ...
  it('should update Ohne-KfW pro m² = 300 € when Ohne-KfW is 30000 and Wohnflaeche is 100', () => {
    const ohneKfW = 30000;
    const wohnflaeche = 100;
    const result = service.updateOhneKfwM2(ohneKfW, wohnflaeche);
    expect(result).toBe(300);
  });
  ...
  it('should update Mit-KfW pro m² = 300 € when Mit-KfW is 30000 and Wohnflaeche is 100', () => {
    const mitKfW = 30000;
    const wohnflaeche = 100;
