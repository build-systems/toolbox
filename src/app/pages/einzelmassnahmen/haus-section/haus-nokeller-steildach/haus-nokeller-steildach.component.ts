...
@Component({
  selector: 'app-haus-nokeller-steildach',
  standalone: true,
  imports: [],
  templateUrl: './haus-nokeller-steildach.component.svg',
  styleUrl: './haus-nokeller-steildach.component.css',
  host: {
    class: 'host-house',
  },
})
...
export class HausNokellerSteildachComponent implements AfterViewInit {
