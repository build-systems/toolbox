...
export class FormProjektNeubauComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.projektFormNeu = this.fb.group({
      ...
      userPriceToggle: new FormControl(!this.formService.userPrice.disabled),
      userPriceRange: [
        this.formService.userPrice.value, // init
        [
      ...
      wohnflaecheRange: [
        ...
        this.formService.wohnflaeche.value,
        [
      ...
      anzahlWohnungenRange: [
        this.formService.anzahlWohnungen.value,
        [
      ...
      grundstuecksbezogeneKostenRange: [
        this.formService.grundstKosten.value,
        [
    ...
    this.projektFormNeu
      ...
      ?.valueChanges.subscribe((value) => {
        ...
        if (value === 'Nicht Vorhanden') {
          ...
          this.formService.stellplaetze.options[0].disabled = true;
          this.noKellergeschoss = true;
        } else {
          this.formService.stellplaetze.options[0].disabled = false;
